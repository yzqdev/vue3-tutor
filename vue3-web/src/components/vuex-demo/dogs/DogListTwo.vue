...
<script setup>
import { dogStore } from "@/store/dogs";
let store = dogStore();

let dogs = $ref(store.dogs);
let minusPriceAsync = store.minusPriceAsync;
let plusPrice = store.plusPrice;
let minusPrice = store.minusPrice;
</script>
